          ...
          (function (n) {
            ...
            if (!a || !l) {
              ...
              (a = function (t) {
                ...
                return (
                  f.push({ handle: ++c, callback: t, cancelled: !1 }), c
                );
              }),
                (l = function (t) {
        ...
        function (t, e, n) {
          ...
          (i.prototype._notify = function (t) {
            ...
            (i.prototype._onTouchMove = function (t) {
              ...
              (n.deltaX =
                (i.pageX - this.touchStartX) * e.touchMultiplier),
                (n.deltaY =
                  (i.pageY - this.touchStartY) * e.touchMultiplier),
